...
const definitions: ThemePaletteDefinition[] = [
  ...
  },
  {
    ...
    {
    ...makePalette("ember", "暮火信标", "#ff6b6b", "#d94848", "#b33535", "rgba(217,72,72,.14)", "#ff7a7a", "#ffb087", "rgba(255,122,122,.22)", { pageBg: "#fff1ec", panelBg: "#fff8f5", elevatedBg: "#ffe4db", sidebarBg: "#fde8e1", text: "#3a1f1f", muted: "#8a5a55", border: "#efc8c0" }, { pageBg: "#1a0f14", panelBg: "#26151c", elevatedBg: "#341f28", sidebarBg: "#140b10", text: "#ffe8e4", muted: "#d0a39a", border: "#4d2b35" }),
    featured: true,
    tagline: "夜市霓虹、偏暖、带一点电影感",
    preview: ["#1a0f14", "#341f28", "#ff7a7a"],
  },
  {
    ...makePalette("glacier", "冰原终端", "#3ec7ff", "#1493c9", "#0d6f9b", "rgba(20,147,201,.14)", "#63d8ff", "#b7f0ff", "rgba(99,216,255,.22)", { pageBg: "#eef8ff", panelBg: "#f8fcff", elevatedBg: "#dcefff", sidebarBg: "#e5f3ff", text: "#123247", muted: "#567891", border: "#bdd8eb" }, { pageBg: "#07131d", panelBg: "#0d1d2b", elevatedBg: "#13293b", sidebarBg: "#081520", text: "#e8f7ff", muted: "#8eb3c9", border: "#234560" }),
    featured: true,
    tagline: "冷静、清晰、像高精度仪表盘",
    preview: ["#07131d", "#13293b", "#63d8ff"],
  },
  {
    ...makePalette("noir", "紫夜影院", "#b57bff", "#7d45d6", "#5f30ad", "rgba(125,69,214,.14)", "#c9a0ff", "#f0a8ff", "rgba(201,160,255,.22)", { pageBg: "#f4efff", panelBg: "#fbf8ff", elevatedBg: "#e8ddff", sidebarBg: "#efe8ff", text: "#2a2140", muted: "#6f6488", border: "#d4c7ef" }, { pageBg: "#120c1c", panelBg: "#1b1329", elevatedBg: "#261a3a", sidebarBg: "#0e0916", text: "#f3eaff", muted: "#b5a4d2", border: "#3b2d57" }),
    featured: true,
